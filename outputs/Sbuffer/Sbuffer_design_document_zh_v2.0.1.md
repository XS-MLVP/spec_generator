...
| 文档版本 | v2.0.1 |
| 使用模板版本 | v2.1.0 |
| 前一版本 | [v2.0.0](./Sbuffer_design_document_zh_v2.0.0.md) |
| 版本变更类型 | Patch：使用模板 v2.1.0 重新生成并落实 Mermaid 实际渲染门禁；RTL、I/O 和设计行为不变 |
...
| Elaborated Verilog 顶层 | `Sbuffer` / [`manifest.json`](../../evidence/Sbuffer/v2.0.1/manifest.json)、[`ports.csv`](../../evidence/Sbuffer/v2.0.1/ports.csv) |
...
| 生成命令 | `tools/generate_rtl.sh --module Sbuffer --config DefaultConfig --version v2.0.1` |
| RTL 证据 | [`manifest.json`](../../evidence/Sbuffer/v2.0.1/manifest.json)、[`ports.csv`](../../evidence/Sbuffer/v2.0.1/ports.csv)；SHA-256 `1e1fe1c1fcea11b0e016dfce391dd771c62eff310cdb4702e712d5a9407e027e`；166 ports |
| 图形渲染证据 | [`diagrams/manifest.json`](../../evidence/Sbuffer/v2.0.1/diagrams/manifest.json)；Mermaid CLI 11.16.0；3 张 SVG 均实际渲染成功 |
...
| FACT-006 | DefaultConfig elaborated `Sbuffer` 有 166 个叶端口：37 input、129 output。 | [`ports.csv`](../../evidence/Sbuffer/v2.0.1/ports.csv)、[`manifest.json`](../../evidence/Sbuffer/v2.0.1/manifest.json) | 已确认 | Closed |
...
下表中的数组模式已逐项核对 v2 [`ports.csv`](../../evidence/Sbuffer/v2.0.1/ports.csv)。`i=0..1`、`k=0..2`、`b=0..15`、`p=0..15`；`Elided` 表示 Chisel 字段存在，但在 DefaultConfig 产物中经 feature disable、常量传播或 dead-port elimination 消失。
...
渲染证据：[顶层状态图 SVG](../../evidence/Sbuffer/v2.0.1/diagrams/diagram-01-stateDiagram-v2.svg)。
...
渲染证据：[微架构图 SVG](../../evidence/Sbuffer/v2.0.1/diagrams/diagram-02-flowchart.svg)。图内使用人类可读接口描述；精确 Chisel/Verilog 数组模式保留在 I/O 表，避免 Mermaid 将 `[i]` 等文本误解析为语法。
...
渲染证据：[事务时序图 SVG](../../evidence/Sbuffer/v2.0.1/diagrams/diagram-03-sequenceDiagram.svg)。
